...
const executiveBoard = [
  {
    ...
    members: [
        ...
        { name: 'Naresh Kumar', designation: 'Mentor', image: 'https://placehold.co/400x400.png', hint: 'man portrait' },
  ...
  },
  {
    ...
    members: [
        ...
        { name: 'T Madhavi', designation: 'Mentor', image: 'https://placehold.co/400x400.png', hint: 'woman portrait' },
  ...
  },
  {
    ...
    members: [
        ...
        { name: 'D Anitha', designation: 'Mentor', image: 'https://placehold.co/400x400.png', hint: 'woman portrait' },
  ...
  return (
    <div className="container mx-auto py-16 sm:py-24 space-y-24">
      <div className="text-center">
        <h1 className="font-headline text-5xl font-bold tracking-tight">Executive Board</h1>
        ...
        {executiveBoard.map((board, index) => (
            <section key={index}>
                <h2 className="font-headline text-4xl font-bold text-center mb-12 flex items-center justify-center gap-4">
                    <Users className="text-primary"/> {board.phase}
                </h2>

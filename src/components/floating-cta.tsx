    ...
    <>
      <div className="fixed bottom-6 right-6 z-50">
        <div className="relative group">
          <div className="absolute -inset-1.5 bg-gradient-to-r from-primary to-accent rounded-full md:rounded-lg opacity-75 blur-lg group-hover:opacity-100 transition duration-1000 group-hover:duration-200 animate-[pulse-glow_4s_ease-in-out_infinite]"></div>
          <button
            onClick={() => setIsOpen(true)}
            className="relative p-4 md:px-6 md:py-3 bg-secondary/80 backdrop-blur-md text-foreground rounded-full md:rounded-lg flex items-center justify-center gap-3 shadow-2xl shadow-primary/20 hover:scale-110 transition-transform duration-300"
            aria-label="Get project ideas"
          >
            <span className="font-headline text-sm hidden md:inline">Got an Idea?</span>
            <Lightbulb className="w-6 h-6 text-primary md:animate-pulse" />
          </button>
        </div>
      </div>
